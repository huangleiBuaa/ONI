...
class ClassificationLarge:
    def __init__(self):
        ...
        self.best_prec1 = 0
        self.model_name ='OrthReg_' + self.args.arch + '_' + ext.normalization.setting(self.args) + '_{}'.format(self.args.optimizer)
        self.model_name = self.model_name + '_lr' + str(self.args.lr) + '_' + self.args.lr_method + '_OR' + str(self.args.orthReg)
        ...
        # add orthogonal loss
        reg = self.args.orthReg
        print('-----orthReg:' + str(reg))
    ...
    def add_arguments(self):
        ...
        parser.add_argument('-or', '--orthReg', default=0.0, type=float, metavar='FLOAT',
                            help='')
